...
void update_time() {
  ...
  char timeHour[3], timeMinute[3], timeSecond[3], timeDay[3];
...
void set_time() {
  ...
  while(true) {
    ...
    int pressed = wait_for_button_press();
    if (pressed == PB_UP) temp_hour = (temp_hour + 1) % 24;
    else if (pressed == PB_DOWN) temp_hour = (temp_hour - 1 + 24) % 24;
    else if (pressed == PB_OK) { hours = temp_hour; break; }
  ...
  while(true) {
    ...
    else if (pressed == PB_OK) { minutes = temp_minute; break; }
    else if (pressed == PB_CANCEL) break;
  }
...
void set_alarm(int alarm){
  ...
  while(true) {
    ...
    else if (pressed == PB_OK) { alarm_hours[alarm] = temp_hour; break; }
    else if (pressed == PB_CANCEL) break;
  }
  ...
  while(true) {
    ...
    else if (pressed == PB_OK) { alarm_minutes[alarm] = temp_minute; break; }
    else if (pressed == PB_CANCEL) break;
  }
